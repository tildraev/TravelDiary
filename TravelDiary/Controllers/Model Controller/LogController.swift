...
class LogController {
    ...
    /// Singleton: To ensure that we are interacting with the *SAME* instance of our entries array we created a singleton and will pass around this specific instance of our LogController
